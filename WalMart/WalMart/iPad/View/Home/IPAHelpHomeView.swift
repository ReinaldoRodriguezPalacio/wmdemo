...
class IPAHelpHomeView: HelpHomeView {
    ...
    override func layoutSubviews() {
        ...
        self.shoppingCartIcon?.frame = CGRect(x: self.frame.width - 47, y: 25,width: 35,height: 35)
        self.shoppingCartLabel?.frame = CGRect(x: self.frame.width - 47, y: self.shoppingCartIcon!.frame.maxY + 8,width: 35,height: 14)
