//
//  IPAOrderProviderDetailViewController.swift
//  WalMart
//
//  Created by Luis Alonso Salcido Martinez on 15/06/17.
...
class IPAOrderProviderDetailViewController: OrderProviderDetailViewController {
