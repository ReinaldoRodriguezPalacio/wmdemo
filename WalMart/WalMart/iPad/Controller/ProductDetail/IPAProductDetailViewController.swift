...
class IPAProductDetailViewController : UIViewController {
    ...
    var providerInfoCell: ProductDetailProviderView?
    var cellProviders : UITableViewCell? = nil
    ...
    override func viewDidLoad() {
        ...
        tabledetail.register(UITableViewCell.self, forCellReuseIdentifier: "providerInfoCell")
        tabledetail.register(ProducDetailProviderTableViewCell.self, forCellReuseIdentifier: "producDetailProviderTableViewCell")
    ...
    func loadDataFromService() {
        ...
        productService.callService(requestParams:params, successBlock: { (result: [String:Any]) -> Void in
            ...
            let offerDommy = [["offerId": "00001556110217_002","name": "seller 1","sellerId": "1234561","price": "5219.00","rating": 4.0,"condition": 0,"shipping":"Envío de 1 a semanas","onHandInventory": "2"],["offerId": "00001556110217_003","name": "seller 2","sellerId": "1234562","price": "5319.00","rating": 4.5,"condition": 1,"shipping":"Envío de 1 a semanas","onHandInventory": "2"],["offerId": "00001556110217_004","name": "seller 3","sellerId": "1234563","price": "5419.00","rating": 3.8,"condition": 0,"shipping":"Envío de 1 a semanas","onHandInventory": "2"],["offerId": "00001556110217_005","name": "seller 4","sellerId": "1234564","price": "5519.00","rating": 3.3,"condition": 1,"shipping":"Envío de 1 a semanas","onHandInventory": "2"],["offerId": "00001556110217_006","name": "seller 5","sellerId": "1234565","price": "5619.00","rating": 2.8,"condition": 0,"shipping":"Envío de 1 a semanas","onHandInventory": "2"],["offerId": "00001556110217_001","name": "seller 6","sellerId": "1234566","price": "5719.00","rating": 4.8,"condition": 1,"shipping":"Envío de 1 a semanas","onHandInventory": "2"],["offerId": "00001556110217_007","name": "seller 7","sellerId": "1234567","price": "5819.00","rating": 3.3,"condition": 0,"shipping":"Envío de 1 a semanas","onHandInventory": "2"],["offerId": "00001556110217_010","name": "seller 8","sellerId": "1234568","price": "5919.00","rating": 4.6,"condition": 1,"shipping":"Envío de 1 a semanas","onHandInventory": "2"],["offerId": "00001556110217_008","name": "seller 9","sellerId": "1234569","price": "6019.00","rating": 2.0,"condition": 0,"shipping":"Envío de 1 a semanas","onHandInventory": "2"],["offerId": "00001556110217_009","name": "seller 10","sellerId": "1234560","price": "6119.00","rating": 5.0,"condition": 1,"shipping":"Envío de 1 a semanas","onHandInventory": "2"]]
...
extension IPAProductDetailViewController: UITableViewDelegate {
...
extension IPAProductDetailViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        case 0:
            if !self.isContainerHide {
                return  self.hasProvider ? 7 : 6
            }
            return  self.hasProvider ? 6 : 5
...
extension IPAProductDetailViewController: ProductDetailCrossSellViewDelegate {
...
extension IPAProductDetailViewController: ProductDetailButtonBarCollectionViewCellDelegate {
    func shareProduct() {
...
extension IPAProductDetailViewController: UIActivityItemSource {
...
extension IPAProductDetailViewController: ProductDetailBannerCollectionViewDelegate {
...
extension IPAProductDetailViewController: ProductDetailColorSizeDelegate {
...
extension IPAProductDetailViewController: ProductDetailProviderViewDelegate {
    func buildProviderInfoView(_ width: CGFloat) {
        if self.providerInfoCell != nil {
            self.clearView(self.providerInfoCell!)
        }
        
        self.providerInfoCell = ProductDetailProviderView(frame: CGRect(x:0, y:0, width: width,height: 70))
        self.providerInfoCell?.delegate = self
        self.providerInfoCell?.offersCount = self.providerArray!.count 
        self.providerInfoCell?.setValues(provider: self.providerInfo!)
        self.providerInfoCell?.bottomBorder.removeFromSuperlayer()
    }
