...
class TouristInformationForm: UIView,TPKeyboardAvoidingScrollViewDelegate, UIScrollViewDelegate {
    ...
    func setup() {
        ...
        arrivalButton!.setTitleColor(WMColor.reg_gray, forState: UIControlState.Normal)
        ...
        departureButton!.setTitleColor(WMColor.reg_gray, forState: UIControlState.Normal)
