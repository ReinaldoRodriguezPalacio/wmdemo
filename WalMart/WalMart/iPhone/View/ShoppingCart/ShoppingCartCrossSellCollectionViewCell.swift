...
class ShoppingCartCrossSellCollectionViewCell : ProductDetailCrossSellTableViewCell {
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if (!UserCurrentSession.sharedInstance.userHasUPCShoppingCart(upc)) {
            ...
            let params = CustomBarViewController.buildParamsUpdateShoppingCart(upc, desc: desc, imageURL: imageUrl, price: price, quantity: "1", comments: "", onHandInventory: numOnHandInventory, type: "", pesable: "0", isPreorderable: isPreorderable)
