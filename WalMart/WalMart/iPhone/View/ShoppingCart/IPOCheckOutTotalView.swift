...
class IPOCheckOutTotalView : UIView {
    ...
    func setTotalValues(_ numProds: String,subtotal: String,saving:String){
       ...
       // let formatedSubTotal = CurrencyCustomLabel.formatString(subtotal)
        subtotalValueLabel.updateMount( CurrencyCustomLabel.formatString(String(subNewTotal) as NSString), font: WMFont.fontMyriadProRegularOfSize(12), color: WMColor.gray, interLine: false)
