    ...
    func deleteRowAtIndexPath(indexPath : NSIndexPath){
        ...
        var allUPCS : [String] = []
         allUPCS.append(upc)
            ...
            //EVENT
            BaseController.sendAnalytics(WMGAIUtils.GR_CATEGORY_SHOPPING_CART_AUTH.rawValue, categoryNoAuth: WMGAIUtils.GR_CATEGORY_SHOPPING_CART_AUTH.rawValue, action: WMGAIUtils.ACTION_DELETE_PRODUCT_CART.rawValue, label: "\(itemGRSC["description"] as! String) - \(upc)")
