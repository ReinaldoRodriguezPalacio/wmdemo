...
class SearchProductViewController: NavigationViewController {
 ...
 extension SearchProductViewController: UIViewControllerPreviewingDelegate {
 ...
 extension SearchProductViewController:  FilterProductsViewControllerDelegate {
 ...
 extension SearchProductViewController:  SearchProductCollectionViewCellDelegate {
    ...
    func buildMGSelectQuantityView(_ cell: SearchProductCollectionViewCell, viewFrame: CGRect,quantity:String){
        let startY: CGFloat = IS_IPAD ? 2 : 64
