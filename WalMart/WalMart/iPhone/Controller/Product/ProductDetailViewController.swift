...
class ProductDetailViewController : IPOBaseController,UICollectionViewDataSource,UICollectionViewDelegate,ListSelectorDelegate,ProductDetailCrossSellViewDelegate,ProductDetailButtonBarCollectionViewCellDelegate ,ProductDetailBannerCollectionViewDelegate,UIActivityItemSource, ProductDetailColorSizeDelegate,UIGestureRecognizerDelegate {
    ...
    func buildParamsUpdateShoppingCart(quantity:String) -> [NSObject:AnyObject] {
        ...
        return ["skuid":self.sku,"upc":self.upc,"desc":self.name,"imgUrl":imageUrlSend,"price":self.price,"quantity":quantity,"onHandInventory":self.onHandInventory,"wishlist":false,"type":ResultObjectType.Mg.rawValue,"pesable":pesable,"isPreorderable":self.strisPreorderable,"category":self.productDeparment]
    }
