...
class MoreOptionsViewController: IPOBaseController, UITableViewDelegate, UITableViewDataSource, CameraViewControllerDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 2:
            currentOption = (indexPath as NSIndexPath).row + (self.showCamfind! ? 10 : 9)
        ...
        case .Preferences : image = "Preferences_icon"
        ...
        default :
         ...
         if UserCurrentSession.sharedInstance.userSigned == nil && ((indexPath as NSIndexPath).section == 0 || ((indexPath as NSIndexPath).section == 1 && (indexPath as NSIndexPath).row == 2 && self.showCamfind)) {
            ...
            case .Preferences : image = "Preferences_disable_icon"
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case .Profile : let controller = EditProfileViewController()
        ...
        case .Recents: let controller = RecentProductsViewController()
                self.navigationController!.pushViewController(controller, animated: true)
        case .Address: let controller = MyAddressViewController()
            self.navigationController!.pushViewController(controller, animated: true)
        case .Orders:
