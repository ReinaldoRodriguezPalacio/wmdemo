...
- (void)drawRect:(CGRect)rect
{
    ...
    */
    ...
    [titleText drawAtPoint:titlePoint withAttributes:@{NSFontAttributeName:self.tileTitleFont,NSForegroundColorAttributeName:titleColor}];
    if (self.numberOfDots > 0) {
        [dotsText drawAtPoint:dotsPoint withAttributes:@{NSFontAttributeName:self.tileDotFont}];
    }
}
