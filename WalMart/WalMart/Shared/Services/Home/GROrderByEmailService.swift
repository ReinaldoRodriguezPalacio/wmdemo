...
class GROrderByEmailService : GRBaseService {
    ...
    func buildParams(total:String,month:String,year:String,day:String,device:String,comments:String,paymentType:String,pickingInstruction:String,AddressID:String,deliveryTypeString:String,deliveryType:String,hour:String) -> NSDictionary {
