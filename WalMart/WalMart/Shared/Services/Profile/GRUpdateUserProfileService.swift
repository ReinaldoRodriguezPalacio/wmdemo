...
class GRUpdateUserProfileService : GRBaseService {
    ...
    func buildParams(name:String,lastName:String,sex:String,birthDate:String,maritalStatus:String,profession:String,workNumberExtension:String,phoneHomeNumber:String,homeNumberExtension:String,cellPhone:String,allowMarketingEmail:String,user:String,password:String,newPassword:String,maximumAmount:Int,device:String) -> NSDictionary {
        return ["name":name, "lastName":lastName, "sex":sex, "birthDate":birthDate, "maritalStatus":maritalStatus, "profession":profession,"workNumberExtension":workNumberExtension,"phoneHomeNumber":phoneHomeNumber,"homeNumberExtension":homeNumberExtension,"cellPhone":cellPhone,"allowMarketingEmail":allowMarketingEmail, "isReply": "1","device":device,"user":["password":password,"newPassword":newPassword,"maximumAmount":maximumAmount]]
    }
