...
class DeleteAddressesByUserService : BaseService {
    ...
    func buildParams(_ idAddressParam:String) -> [String:AnyObject] {
        self.idAddress = idAddressParam
        return ["addressId":idAddressParam as AnyObject]
    }
    
    func callService(_ params:[String:AnyObject],successBlock:((NSDictionary) -> Void)?, errorBlock:((NSError) -> Void)? ) {
