...
class ProductDetailCrossSellCollectionViewCell : UICollectionViewCell, UICollectionViewDataSource,UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        delegate.goTODetailProduct(upc, items: upcItems,index:(indexPath as NSIndexPath).row,imageProduct: currentCell!.productImage!.image!,point:pontInView,idList: self.idListSelectdFromSearch)
